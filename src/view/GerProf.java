...
public class GerProf extends JFrame {
	...
	public GerProf() {
		...
		btnAdd.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				 AddProf add = new AddProf();
			        
				 
				    add.setVisible(true);
			        GerProf.this.dispose();
